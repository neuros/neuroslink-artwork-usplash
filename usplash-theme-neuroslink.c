...
/* Mythbuntu PixMap Colors */
#define MYTHBUNTU_BLACK     0
#define MYTHBUNTU_SILVER    201
#define MYTHBUNTU_WHITE     0xFFFF
#define MYTHBUNTU_RED       0xEA2A2A2
#define MYTHBUNTU_GREEN     0x3FCD37
...
struct usplash_theme usplash_theme = {
	...
	/* Palette indexes */
	.background             = MYTHBUNTU_BLACK,
  	.progressbar_background = MYTHBUNTU_BLACK,
  	.progressbar_foreground = MYTHBUNTU_SILVER,
	.text_background        = MYTHBUNTU_BLACK,
	.text_foreground        = MYTHBUNTU_WHITE,
	.text_success           = MYTHBUNTU_GREEN,
	.text_failure           = MYTHBUNTU_RED,

	/* Progress bar position and size in pixels */
  	.progressbar_x      = 196, /* 640/2 - 248/2 */ 
  	.progressbar_y      = 230, /* 400/2 + 10*3 */
  	.progressbar_width  = 248,
...
struct usplash_theme usplash_theme_800_600 = {
	...
	/* Progress bar position and size in pixels */
  	.progressbar_x      = 276, /* 800/2 - 248/2 */
  	.progressbar_y      = 330, /* 600/2 + 10*3 */
   	.progressbar_width  = 248,
  	.progressbar_height = 10,
...
struct usplash_theme usplash_theme_1024_768 = {
	...
	/* Progress bar position and size in pixels */
  	.progressbar_x      = 388, /* 1024/2 - 248/2 */ 
  	.progressbar_y      = 414, /* 768/2 + 10*3 */
  	.progressbar_width  = 248,
  	.progressbar_height = 10,
...
struct usplash_theme usplash_theme_1365_768_scaled = {
	...
	/* Progress bar position and size in pixels */
  	.progressbar_x      = 599, /* 1366/2 - 248/2 */ 
  	.progressbar_y      = 414, /* 768/2 + 10*3 */ 
  	.progressbar_width  = 248,
  	.progressbar_height = 10,
